...
export class DepressionStrategy {
  ...
  constructor(private readonly depressionFactory: DepressionFactory) {}
  ...
  async create(
    ...
    return await this.depressionFactory.create(data, user, student, type);
  }
  ...
  async update(
    ...
    return await this.depressionFactory.update(id, type, data, evaluation);
  }
